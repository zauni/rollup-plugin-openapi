...
[configuration file](https://vitejs.dev/config/#config-file) and import the
plugin:
...
[CLI](https://vitejs.dev/guide/#command-line-interface) or the
[API](https://vitejs.dev/guide/api-javascript.html).
...
installed you can now render it. With Vite you get Hot Module Reload for free.
